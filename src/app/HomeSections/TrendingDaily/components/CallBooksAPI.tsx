...
const CallBooksAPI = () => {
	...
	const renderBooks = async () => {
		...
		return booksData.slice(0, qtnBooks).map((booksInfos: { key: React.Key | null | undefined; title: string; cover_i: string; first_publish_year: number; edition_count: number; }) => (
