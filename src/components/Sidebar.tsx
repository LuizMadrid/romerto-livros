	...
	return (
		<>
			<div className='h-screen flex justify-center items-start group/sidebar'>
				...
				<div className='h-full bg-white dark:bg-primaryDark text-base flex flex-col justify-between absolute top-0 left-0 group-hover/sidebar:absolute group-hover/sidebar:top-0 group-hover/sidebar:left-0'>
					<ul className='text-gray-500 dark:text-gray-300 font-bold w-[60px] group-hover/sidebar:w-full flex flex-col gap-4 p-2'>
						...
						<li className='group my-0 group-hover/sidebar:my-[1px]'>
							<Link href={'/'}>
						...
						<li className='group my-[1px] group-hover/sidebar:mt-0'>
							<Link href={'/'}>
